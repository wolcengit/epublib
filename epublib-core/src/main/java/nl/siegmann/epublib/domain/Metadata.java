...
public class Metadata implements Serializable {
    ...
    private Map<String, String> dcAttributes = new HashMap<String, String>();
    ...
    public Map<String, String> getDcAttributes() {
        return dcAttributes;
    }

    public void setDcAttributes(Map<String, String> dcAttributes) {
